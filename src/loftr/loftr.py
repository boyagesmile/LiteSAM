...
class LoFTR(nn.Module):
    ...
    def forward(self, data, config=None, logger=None):
        """ 
        Update:
            data (dict): {
        ...
        data.update({'backbone_time': self.start_event.elapsed_time(self.end_event)})
        ...
        self.end_event.record()
        torch.cuda.synchronize()
        data.update({'coarse_level_time': self.start_event.elapsed_time(self.end_event)})
        ...
        self.end_event.record()
        torch.cuda.synchronize()
        data.update({'coarse_matching_time': self.start_event.elapsed_time(self.end_event)})
        ...
        self.end_event.record()
        torch.cuda.synchronize()
        data.update({'fine_level_time': self.start_event.elapsed_time(self.end_event)})
        ...
        self.end_event.record()
        torch.cuda.synchronize()
        data.update({'fine_matching_time': self.start_event.elapsed_time(self.end_event)})
