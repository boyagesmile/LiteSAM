...
# training config
cfg.TRAINER.CANONICAL_LR = 2e-2  #1e-2
cfg.TRAINER.WARMUP_STEP = 1875  # 3 epochs
cfg.TRAINER.WARMUP_RATIO = 0.1
cfg.TRAINER.MSLR_MILESTONES = [8, 12, 16, 20, 24, 28, 34, 40, 46, 52]
cfg.TRAINER.SCHEDULER = 'CosineAnnealing'  # MultiStepLR
...
cfg.LOFTR.LOSS.LOCAL_WEIGHT = 0.15
